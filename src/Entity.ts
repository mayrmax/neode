 ...
 * @return {Mixed}
 */
export function valueToJson(property: string, value: any) {
...
export class Entity<T = any> {
    protected _identity: neo4j.Integer;
    protected _neode:Neode;
    protected _model:Model;

    protected _properties:Map<string, Property>;
    protected _definition: RelationshipType;
    protected _eager:Map<string, any>;
