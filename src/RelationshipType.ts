...
export class RelationshipType {
    ...
    private _target:string | Model | null | undefined;
    private _schema:RelationshipSchema;
    public _eager:boolean;
    private _cascade: boolean | string;
    private _node_alias:string;
