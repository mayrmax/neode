 ...
 */
function splitProperties(mode, model, properties, merge_on:any[] = []) {
    const inline = {};
    const set = {};
    const on_create = {};
    const on_match = {};
 ...
 */
export function addNodeToStatement(neode, builder, alias:string, model, properties, aliases:string[] = [], mode = 'create', merge_on = []) {
    // Split Properties
